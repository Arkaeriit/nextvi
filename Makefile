# Flags
CFLAGS += -Wpedantic -Wall -Wextra -Wno-implicit-fallthrough -Wno-missing-field-initializers -Wno-unused-parameter -Wfatal-errors -Wno-strict-prototypes -Wno-maybe-uninitialized -std=c99 -D_POSIX_C_SOURCE=200809L -O2 -g
